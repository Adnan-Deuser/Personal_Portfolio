...
const projects = [
  ...
  },
  {
    ...
    description:
      "An E-commerce Store is a full-stack web application that allows users to browse products, add items to a cart, and complete purchases online.It provides product listings, search, filters, and a secure checkout process.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            ...
            innovative tools that are attractive and cool.
          </p>
        </div>
